...
from views import AboutFrame, RegistrationFrame, SearchFrame, UpdateFrame, DeleteFrame, PaymentFrame,CheckinFrame, TribeFrame
...
class MainPage:
    ...
    def create_page(self):
        ...
        self.notebook.add(self.tribe_frame, text="Tribe")
